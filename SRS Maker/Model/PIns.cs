...
namespace SRS_Maker.Model
{
    ...
    {
        public string Name;
        public List<int?> PinNumber;  // List's first element is 80 pin package's pin number, second element is 100 pin package...
        public List<string> Usage;      // GPIO, ADC, CAN Tx, CAN Rx, SPI Tx, SPI Rx, SPI Clk, ASC Tx, ASC Rx, External Interrup, Input Capture, Output Compare, PWM, 
    ...
    class Pins
    {
        ...
        {
            /* Port A Group ============================================================================== */
            PinList.Add(new Pin() { Name = "PA0",  PinNumber = { 12,  16,  24  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PA1",  PinNumber = { 7,   11,  19  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PA2",  PinNumber = { 5,   9,   17  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PA3",  PinNumber = { 68,  90,  114 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PA4",  PinNumber = { 29,  43,  51  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PA5",  PinNumber = { 79,  118, 146 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PA6",  PinNumber = { 80,  119, 147 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PA7",  PinNumber = { 71,  104, 128 }, Usage = { "GPIO" } });

            PinList.Add(new Pin() { Name = "PA8",  PinNumber = { 72,  105, 129 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PA9",  PinNumber = { 73,  106, 130 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PA10", PinNumber = { 74,  107, 131 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PA11", PinNumber = { 75,  108, 132 }, Usage = { "GPIO" } });
            ...
            PinList.Add(new Pin() { Name = "PC12", PinNumber = { 97,  141, 173 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PC13", PinNumber = { 98,  142, 174 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PC14", PinNumber = { 3,   3,   3   }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PC15", PinNumber = { 4,   4,   4   }, Usage = { "GPIO" } });
            ...
            /* Port E Group ============================================================================== */
            PinList.Add(new Pin() { Name = "PE0",  PinNumber = { 6,   10,  18  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PE1",  PinNumber = { 8,   12,  20  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PE2",  PinNumber = { 89,  128, 156 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PE3",  PinNumber = { 90,  129, 157 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PE4",  PinNumber = { 93,  132, 160 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PE5",  PinNumber = { 94,  133, 161 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PE6",  PinNumber = { 95,  139, 167 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PE7",  PinNumber = { 96,  140, 168 }, Usage = { "GPIO" } });
            ...
            PinList.Add(new Pin() { Name = "PE13", PinNumber = {      103, 127 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PE14", PinNumber = {      112, 136 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PE15", PinNumber = {      113, 137 }, Usage = { "GPIO" } });
            ...
            /* Port G Group ============================================================================== */
            PinList.Add(new Pin() { Name = "PG0",  PinNumber = {      98,  122 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG1",  PinNumber = {      97,  121 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG2",  PinNumber = {      8,   16  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG3",  PinNumber = {      7,   15  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG4",  PinNumber = {      6,   14  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG5",  PinNumber = {      5,   13  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG6",  PinNumber = {      30,  38  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG7",  PinNumber = {      29,  37  }, Usage = { "GPIO" } });

            PinList.Add(new Pin() { Name = "PG8",  PinNumber = {      26,  34  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG9",  PinNumber = {      25,  33  }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG10", PinNumber = {      114, 138 }, Usage = { "GPIO" } });
            ...
            PinList.Add(new Pin() { Name = "PG14", PinNumber = {      110, 134 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG15", PinNumber = {      111, 135 }, Usage = { "GPIO" } });

            /* Port H Group ============================================================================== */
            PinList.Add(new Pin() { Name = "PH0",  PinNumber = {      93,  117 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PH1",  PinNumber = {      94,  118 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PH2",  PinNumber = {      95,  119 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PH3",  PinNumber = {      96,  120 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PH4",  PinNumber = {      134, 162 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PH5",  PinNumber = {      135, 163 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PH6",  PinNumber = {      136, 164 }, Usage = { "GPIO" } });
            PinList.Add(new Pin() { Name = "PH7",  PinNumber = {      137, 165 }, Usage = { "GPIO" } });

            PinList.Add(new Pin() { Name = "PH8",  PinNumber = {      138, 166 }, Usage = { "GPIO" } });
