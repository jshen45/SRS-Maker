...
namespace SRS_Maker.Model
{
    ...
    public class Pins
    {
        ...
        public Pins(string pinNumber)
        {
            ...
            PinList.Add(new Pin() { Name = "PA12", PinNumber = new List<int?> { 31, 45, 53 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "SPI0 IN" } });
            PinList.Add(new Pin() { Name = "PA13", PinNumber = new List<int?> { 30, 44, 52 }, Usage = new List<string> { "GPIO", "SPI0 OUT"} });
            PinList.Add(new Pin() { Name = "PA14", PinNumber = new List<int?> { 28, 42, 50 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "SPI0 CLK" } });
            PinList.Add(new Pin() { Name = "PA15", PinNumber = new List<int?> { 27, 40, 48 }, Usage = new List<string> { "GPIO", "SPI0 CLK" } });

            /* Port B Group(1) ============================================================================== */
            PinList.Add(new Pin() { Name = "PB0", PinNumber = new List<int?> { 23, 31, 39 }, Usage = new List<string> { "GPIO", "CAN0 TX"} });
            PinList.Add(new Pin() { Name = "PB1", PinNumber = new List<int?> { 24, 32, 40 }, Usage = new List<string> { "GPIO", "CAN0 RX", "WakeUpInterrupt" } });
            PinList.Add(new Pin() { Name = "PB2", PinNumber = new List<int?> { 100, 144, 176 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "CAN RX" } });
            PinList.Add(new Pin() { Name = "PB3", PinNumber = new List<int?> { 1, 1, 1 }, Usage = new List<string> { "GPIO", "ExternalInterrup" } });
            PinList.Add(new Pin() { Name = "PB4", PinNumber = new List<int?> { 50, 72, 88 }, Usage = new List<string> { "GPIO", "ExternalInterrup" } });
            PinList.Add(new Pin() { Name = "PB5", PinNumber = new List<int?> { 53, 75, 91 }, Usage = new List<string> { "GPIO", "ExternalInterrup" } });
            ...
            PinList.Add(new Pin() { Name = "PB12", PinNumber = new List<int?> { 63, 85, 103 }, Usage = new List<string> { "GPIO", "ExternalInterrup" } });
            PinList.Add(new Pin() { Name = "PB13", PinNumber = new List<int?> { 65, 87, 105 }, Usage = new List<string> { "GPIO" } });
            PinList.Add(new Pin() { Name = "PB14", PinNumber = new List<int?> { 67, 89, 107 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "CAN TX" } });
            ...
            PinList.Add(new Pin() { Name = "PC2", PinNumber = new List<int?> { 78, 117, 145 }, Usage = new List<string> { "GPIO", "CAN4 TX", "SPI1 CLK" } });
            PinList.Add(new Pin() { Name = "PC3", PinNumber = new List<int?> { 77, 116, 144 }, Usage = new List<string> { "GPIO", "CAN1 RX", "CAN4 RX" } });
            PinList.Add(new Pin() { Name = "PC4", PinNumber = new List<int?> { 92, 131, 159 }, Usage = new List<string> { "GPIO", "CAN3 RX", "SPI1 IN" } });
            PinList.Add(new Pin() { Name = "PC5", PinNumber = new List<int?> { 91, 130, 158 }, Usage = new List<string> { "GPIO", "CAN3 TX", "SPI1 OUT" } });
            ...
            PinList.Add(new Pin() { Name = "PC10", PinNumber = new List<int?> { 22, 28, 36 }, Usage = new List<string> { "GPIO", "CAN1 TX", "CAN4 RX" } });
            PinList.Add(new Pin() { Name = "PC11", PinNumber = new List<int?> { 21, 27, 35 }, Usage = new List<string> { "GPIO", "CAN1 RX", "CAN4 RX", "WakeUpInterrupt" } });
            PinList.Add(new Pin() { Name = "PC12", PinNumber = new List<int?> { 97, 141, 173 }, Usage = new List<string> { "GPIO", "PWM", "SPI2 IN" } });
            PinList.Add(new Pin() { Name = "PC13", PinNumber = new List<int?> { 98, 142, 174 }, Usage = new List<string> { "GPIO", "PWM", "SPI2 OUT" } });
            PinList.Add(new Pin() { Name = "PC14", PinNumber = new List<int?> { 3, 3, 3 }, Usage = new List<string> { "GPIO", "PWM", "SPI2 CLK" } });
            ...
            /* Port E Group(4) ============================================================================== */
            PinList.Add(new Pin() { Name = "PE0", PinNumber = new List<int?> { 6, 10, 18 }, Usage = new List<string> { "GPIO", "PWM", "CAN5 RX", "WakeUpInterrupt" } });
            PinList.Add(new Pin() { Name = "PE1", PinNumber = new List<int?> { 8, 12, 20 }, Usage = new List<string> { "GPIO", "PWM", "CAN5 TX" } });
            PinList.Add(new Pin() { Name = "PE2", PinNumber = new List<int?> { 89, 128, 156 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "PWM", "SPI1 IN" } });
            PinList.Add(new Pin() { Name = "PE3", PinNumber = new List<int?> { 90, 129, 157 }, Usage = new List<string> { "GPIO", "PWM", "SPI1 OUT" } });
            PinList.Add(new Pin() { Name = "PE4", PinNumber = new List<int?> { 93, 132, 160 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "PWM", "SPI1 CLK" } });
            PinList.Add(new Pin() { Name = "PE5", PinNumber = new List<int?> { 94, 133, 161 }, Usage = new List<string> { "GPIO", "PWM" } });
            PinList.Add(new Pin() { Name = "PE6", PinNumber = new List<int?> { 95, 139, 167 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "PWM" } });
            PinList.Add(new Pin() { Name = "PE7", PinNumber = new List<int?> { 96, 140, 168 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "PWM" } });

            PinList.Add(new Pin() { Name = "PE8", PinNumber = new List<int?> { 9, 13, 21 }, Usage = new List<string> { "GPIO", "CAN2 TX", "CAN3 TX" } });
            PinList.Add(new Pin() { Name = "PE9", PinNumber = new List<int?> { 10, 14, 22 }, Usage = new List<string> { "GPIO", "CAN2 RX", "CAN3 RX", "WakeUpInterrupt" } });
            PinList.Add(new Pin() { Name = "PE10", PinNumber = new List<int?> { 11, 15, 23 }, Usage = new List<string> { "GPIO", "ExternalInterrup" } });
            PinList.Add(new Pin() { Name = "PE11", PinNumber = new List<int?> { 13, 17, 25 }, Usage = new List<string> { "GPIO" } });
            PinList.Add(new Pin() { Name = "PE12", PinNumber = new List<int?> { 76, 109, 133 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "SPI2 IN" } });
            PinList.Add(new Pin() { Name = "PE13", PinNumber = new List<int?> { 103, 127 }, Usage = new List<string> { "GPIO", "PWM", "SPI2 OUT" } });
            PinList.Add(new Pin() { Name = "PE14", PinNumber = new List<int?> { 112, 136 }, Usage = new List<string> { "GPIO", "PWM", "ExternalInterrup", "SPI2 CLK" } });
            ...
            PinList.Add(new Pin() { Name = "PF8", PinNumber = new List<int?> { 34, 42 }, Usage = new List<string> { "GPIO", "CAN2 TX", "CAN3 TX" } });
            PinList.Add(new Pin() { Name = "PF9", PinNumber = new List<int?> { 33, 41 }, Usage = new List<string> { "GPIO", "CAN2 RX", "CAN3 RX" } });
            ...
            PinList.Add(new Pin() { Name = "PF14", PinNumber = new List<int?> { 102, 126 }, Usage = new List<string> { "GPIO", "CAN1 TX", "CAN4 TX" } });
            PinList.Add(new Pin() { Name = "PF15", PinNumber = new List<int?> { 101, 125 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "CAN1 RX", "CAN1 RX" } });

            /* Port G Group(6) ============================================================================== */
            PinList.Add(new Pin() { Name = "PG0", PinNumber = new List<int?> { 98, 122 }, Usage = new List<string> { "GPIO", "PWM", "CAN5 TX" } });
            PinList.Add(new Pin() { Name = "PG1", PinNumber = new List<int?> { 97, 121 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "PWM", "CAN5 RX" } });
            PinList.Add(new Pin() { Name = "PG2", PinNumber = new List<int?> { 8, 16 }, Usage = new List<string> { "GPIO", "PWM", "SPI3 OUT" } });
            PinList.Add(new Pin() { Name = "PG3", PinNumber = new List<int?> { 7, 15 }, Usage = new List<string> { "GPIO", "PWM" } });
            PinList.Add(new Pin() { Name = "PG4", PinNumber = new List<int?> { 6, 14 }, Usage = new List<string> { "GPIO", "PWM", "SPI3 CLK" } });
            PinList.Add(new Pin() { Name = "PG5", PinNumber = new List<int?> { 5, 13 }, Usage = new List<string> { "GPIO", "PWM", "SPI3 IN" } });
            ...
            PinList.Add(new Pin() { Name = "PG8", PinNumber = new List<int?> { 26, 34 }, Usage = new List<string> { "GPIO", "ExternalInterrup", "PWM" } });
            PinList.Add(new Pin() { Name = "PG9", PinNumber = new List<int?> { 25, 33 }, Usage = new List<string> { "GPIO", "PWM", "SPI2 CLK" } });
            PinList.Add(new Pin() { Name = "PG10", PinNumber = new List<int?> { 114, 138 }, Usage = new List<string> { "GPIO", "PWM", "SPI2 IN" } });
            PinList.Add(new Pin() { Name = "PG11", PinNumber = new List<int?> { 115, 139 }, Usage = new List<string> { "GPIO" } });
            PinList.Add(new Pin() { Name = "PG12", PinNumber = new List<int?> { 92, 116 }, Usage = new List<string> { "GPIO", "SPI4 OUT" } });
            PinList.Add(new Pin() { Name = "PG13", PinNumber = new List<int?> { 91, 115 }, Usage = new List<string> { "GPIO", "SPI4 CLK" } });
            ...
            /* Port H Group(7) ============================================================================== */
            PinList.Add(new Pin() { Name = "PH0", PinNumber = new List<int?> { 93, 117 }, Usage = new List<string> { "GPIO", "PWM", "SPI1 IN" } });
            PinList.Add(new Pin() { Name = "PH1", PinNumber = new List<int?> { 94, 118 }, Usage = new List<string> { "GPIO", "PWM", "SPI1 OUT" } });
            PinList.Add(new Pin() { Name = "PH2", PinNumber = new List<int?> { 95, 119 }, Usage = new List<string> { "GPIO", "PWM", "SPI1 CLK" } });
            ...
            PinList.Add(new Pin() { Name = "PH11", PinNumber = new List<int?> { 140 }, Usage = new List<string> { "GPIO", "SPI3 OUT" } });
            PinList.Add(new Pin() { Name = "PH12", PinNumber = new List<int?> { 141 }, Usage = new List<string> { "GPIO", "SPI3 CLK" } });
            PinList.Add(new Pin() { Name = "PH13", PinNumber = new List<int?> { 9 }, Usage = new List<string> { "GPIO", "SPI4 OUT" } });
            PinList.Add(new Pin() { Name = "PH14", PinNumber = new List<int?> { 10 }, Usage = new List<string> { "GPIO", "SPI4 CLK" } });
            PinList.Add(new Pin() { Name = "PH15", PinNumber = new List<int?> { 8 }, Usage = new List<string> { "GPIO", "SPI5 OUT" } });
            ...
            PinList.Add(new Pin() { Name = "PI4", PinNumber = new List<int?> { 143 }, Usage = new List<string> { "GPIO", "SPI4 OUT" } });
            PinList.Add(new Pin() { Name = "PI5", PinNumber = new List<int?> { 142 }, Usage = new List<string> { "GPIO", "SPI4 CLK" } });
            ...
            PinList.Add(new Pin() { Name = "PI11", PinNumber = new List<int?> { 111 }, Usage = new List<string> { "GPIO", "SPI3 IN" } });
            ...
            PinList.Add(new Pin() { Name = "PI14", PinNumber = new List<int?> { 76 }, Usage = new List<string> { "GPIO", "SPI4 IN" } });
            ...
            PinList.Add(new Pin() { Name = "PI1", PinNumber = new List<int?> { 73 }, Usage = new List<string> { "GPIO", "SPI5 IN" } });
        ...
        public List<string> Can0RxPinList
        {
            get
            {
                if (PinList == null)
                    return null;
                var list = PinList.Where((Pin Possible) => Possible.Usage.Contains("CAN0 RX")).Select((Pin RxPin) => RxPin.Name).ToList();
                return list;
            }
        }
        public List<string> Can0TxPinList
        {
            get
            {
                if (PinList == null)
                    return null;
                var list = PinList.Where((Pin Possible) => Possible.Usage.Contains("CAN0 TX")).Select((Pin RxPin) => RxPin.Name).ToList();
                return list;
            }
        }
        public List<string> Can1RxPinList
        {
            get
            {
                if (PinList == null)
                    return null;
                var list = PinList.Where((Pin Possible) => Possible.Usage.Contains("CAN1 RX")).Select((Pin RxPin) => RxPin.Name).ToList();
                return list;
            }
        }
        public List<string> Can1TxPinList
        {
            get
            {
                if (PinList == null)
                    return null;
                var list = PinList.Where((Pin Possible) => Possible.Usage.Contains("CAN1 TX")).Select((Pin RxPin) => RxPin.Name).ToList();
                return list;
            }
        }
        public List<string> Can2RxPinList
        {
            get
            {
                if (PinList == null)
                    return null;
                var list = PinList.Where((Pin Possible) => Possible.Usage.Contains("CAN2 RX")).Select((Pin RxPin) => RxPin.Name).ToList();
                return list;
            }
        }
        public List<string> Can2TxPinList
        {
            get
            {
                if (PinList == null)
                    return null;
                var list = PinList.Where((Pin Possible) => Possible.Usage.Contains("CAN2 TX")).Select((Pin RxPin) => RxPin.Name).ToList();
                return list;
            }
        }
        public List<string> Can3RxPinList
        {
            get
            {
                if (PinList == null)
                    return null;
                var list = PinList.Where((Pin Possible) => Possible.Usage.Contains("CAN3 RX")).Select((Pin RxPin) => RxPin.Name).ToList();
                return list;
            }
        }
        public List<string> Can3TxPinList
        {
            get
            {
                if (PinList == null)
                    return null;
                var list = PinList.Where((Pin Possible) => Possible.Usage.Contains("CAN3 TX")).Select((Pin RxPin) => RxPin.Name).ToList();
                return list;
            }
        }
        public List<string> Can4RxPinList
        {
            get
            {
                if (PinList == null)
                    return null;
                var list = PinList.Where((Pin Possible) => Possible.Usage.Contains("CAN4 RX")).Select((Pin RxPin) => RxPin.Name).ToList();
                return list;
            }
        }
        public List<string> Can4TxPinList
        {
            get
            {
                if (PinList == null)
                    return null;
                var list = PinList.Where((Pin Possible) => Possible.Usage.Contains("CAN4 TX")).Select((Pin RxPin) => RxPin.Name).ToList();
                return list;
            }
        }
    }
